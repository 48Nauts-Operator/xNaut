...
- **Persistent Agent model selection.** The last provider and model selected in right-pane Agent Chat survive Agent changes, workspace navigation, pane remounts, and application restarts instead of falling back to the global model.
